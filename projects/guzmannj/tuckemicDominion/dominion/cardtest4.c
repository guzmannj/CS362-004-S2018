 ...
 **            Great Hall card from the Dominion card game. The test 
 ...
 **			   TEST 3: Player Receives +1 Action
...
#define TESTCARDNAME "Great Hall"
 ...
 **                 are specific to the tests run on the Great Hall card.
 ************************************************************************/
...
// great_hall card case from original cardEffect() switch-case in dominion.c
/*
    case great_hall:
		//+1 Card
...
/*************************************************************************
 ** Function:                testGreatHallCard
 ** 
 ** Description:    Function to implement the Unit Tests for testing 
 **                 the Dominion Great Hall Card.
 ************************************************************************/

int testGreatHallCard()
{
    char msgPfx[128];
    char msgSfx[128];
    char passMsg[128];
    ...
    // Replace a card in player hand with Great Hall card
	...
	// Run the cardEffect function for Great Hall card
    ...
    strcpy(msgPfx, "TEST 3: Player Receives +1 Action");
    printf("%s\n", msgPfx);
    strcat(msgPfx, ":  ");
    ...
    adjBaseNumActions = baseNumActions + greatHallNumActions;
    ...
    modBaseGst.playedCards[modBaseGst.playedCardCount] = great_hall;
    modBaseGst.playedCardCount++;

    modBaseGst.numActions += greatHallNumActions;
...
/*************************************************************************
 ** Function:           main() method for cardtest4 program
 ** 
 ** Description:    main() method for program to unit test the 
 **                 Great Hall Card from the Dominion Card Game.
 ** Parameters:     none
